...
<p class="cqa-note">This event took place on 19 June 2026. The programme below is retained as a record of the educational activity.</p>

**Held in association with the [9th Colombian HPC Summer School](/summer_school_9/)**

## Objective
<p style="text-align: justify; text-justify: inter-word;">
Quantum Day 2026 brought together participants from Xanadu and Amazon Braket for introductory training in quantum computing. The programme covered quantum platforms, access to cloud computing resources, and practical workflows using contemporary quantum software.
</p>
...
## Programme Structure
<p style="text-align: justify; text-justify: inter-word;">
The programme consisted of two technical sessions that blend platform vision, hardware insight, and hands-on experimentation:
</p>

## Session 1: Quantum Computing with Amazon Braket
<p style="text-align: justify; text-justify: inter-word;">
An overview of the current quantum ecosystem with a focus on Amazon Braket and the provider landscape. The session addressed hardware providers, cloud access, and the execution of experiments on available quantum devices.
</p>
...
<p style="text-align: justify; text-justify: inter-word;">
A practical introduction to quantum programming using Team Xanadu’s PennyLane library and hybrid quantum-classical workflows. The session covered writing, optimising, and executing quantum circuits and hybrid workflows.
</p>
...
**Spanish and English:** The programme provided for sessions, tutorials, and instructions in Spanish and English.

## Participation requirements at the time of the event

* Create a free account at [pennylane.ai](https://pennylane.ai/). An account was listed as a requirement for downloading the session notebooks.
* Possess basic knowledge of Python.
* **CyberColombia** was designated to distribute the link to participating host universities.
